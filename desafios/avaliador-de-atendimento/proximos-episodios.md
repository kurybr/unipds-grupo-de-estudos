...
- Interações com serviços publicos
    - Reclame aqui 
...
----> Avaliação de resultado ( "fine tuning" )
( como guardar esses feedbacks )


-----> 
API Publica / Serviço Publico do Governo 
( Relacionados a reclamações )
web search allow list agents tool